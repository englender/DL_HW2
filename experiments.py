...
def run_experiment(run_name, out_dir='./results', seed=None, device=None,
    ...
    model = MODEL_TYPES[model_type](in_size=in_size, out_classes=num_classes, channels=channels,
    ...
    fit_res = trainer.fit(dl_train=dl_train, dl_test=dl_test,num_epochs=epochs,early_stopping=early_stopping, **kw)
